...
public class Emloyee_Component extends javax.swing.JPanel {

    public Emloyee_Component() {
        initComponents();
        setLayout();
        addComponent();
    }
    ...
    private void addComponent() {
        ...
        AllComponent_Employee personalProfile_Hotline = new AllComponent_Employee();
