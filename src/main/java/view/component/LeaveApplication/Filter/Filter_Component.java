...
public class Filter_Component extends javax.swing.JPanel {
    ...
    private void settingFromDateChooser() {
        ...
        fromDateChooser.setMinSelectableDate(minDate);

        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMaximum(Calendar.DAY_OF_MONTH));  // Lấy ngày cuối cùng của tháng
        Date maxDate = cal.getTime();
        fromDateChooser.setMaxSelectableDate(maxDate);
    }
    ...
    private void settingToDateChooser() {
        ...
        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMaximum(Calendar.DAY_OF_MONTH));  // Lấy ngày cuối cùng của tháng
        Date maxDate = cal.getTime();
        toDateChooser.setMaxSelectableDate(maxDate);
    }
