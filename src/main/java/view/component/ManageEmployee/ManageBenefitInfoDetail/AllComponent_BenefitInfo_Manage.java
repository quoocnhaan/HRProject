...
public class AllComponent_BenefitInfo_Manage extends javax.swing.JPanel {
    ...
    private void addComponent() {
        this.add(new DayOff_Component_Manage());
        this.add(new MaternityLeave_Component_Manage());
        this.add(new HealthInsurance_Component_Manage());
        this.add(new TransportAllowance_Component_Manage());
    }
