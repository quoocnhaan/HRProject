...
import view.component.Product.ProductFeature.ProductName_Component;
import view.component.Product.ProductFeature.Feature_Component;
...
public class Product_Component extends javax.swing.JPanel {
    ...
    private void addComponents() {
        ...
        for (int i = 1; i <= 7; i++) {
            Feature_Component subFeature = new Feature_Component("Calvin Keinnnnn");
